...
ORDINARY_PLURAL_ENTRY_TEXT = {
    "amphibians": "amphibian",
    "antacid tablets": "antacid tablet",
    "ants": "ant",
    "apartment ads": "apartment ad",
    "apartment listings": "apartment listing",
    "appetizers": "appetizer",
    "arteries": "artery",
    "attachments": "attachment",
    "automatic baking products": "automatic baking product",
    "baby wipes": "baby wipe",
    "beads": "bead",
    "beds": "bed",
    "berries": "berry",
    "beverages": "beverage",
    ...
    "car rental counters": "car rental counter",
    "cards": "card",
    ...
    "coins": "coin",
    "cold tablets": "cold tablet",
    "color markers": "color marker",
    "colored pencils": "colored pencil",
    "compass directions": "compass direction",
    ...
    "environmental problems": "environmental problem",
    "eye drops": "eye drop",
    "eyelashes": "eyelash",
    "fleas": "flea",
    "foreign language fuses": "foreign language fuse",
    "fractions": "fraction",
    "french fries": "french fry",
    "front steps": "front step",
    "frozen dinners": "frozen dinner",
    ...
    "hiccups": "hiccup",
    "home fries": "home fry",
    "household items": "household item",
    "ideas": "idea",
    "insects": "insect",
    "job ads": "job ad",
    "job ad abbreviations": "job ad abbreviation",
    "juice paks": "juice pak",
    "juices": "juice",
    "jumper cables": "jumper cable",
    "kidneys": "kidney",
    "knee pads": "knee pad",
    ...
    "lights": "light",
    "liquid vitamins": "liquid vitamin",
    "lungs": "lung",
    ...
    "olives": "olive",
    "other instruments": "other instrument",
    "oysters": "oyster",
    "pancakes": "pancake",
    "paper plates": "paper plate",
    "paper products": "paper product",
    "paper towels": "paper towel",
    "parallel bars": "parallel bar",
    "parents": "parent",
    "pearls": "pearl",
    "perpendicular lines": "perpendicular line",
    "pickles": "pickle",
    "plains": "plain",
    "plays": "play",
    "poems": "poem",
    ...
    "restrooms": "restroom",
    "ribs": "rib",
    "road test instructions": "road test instruction",
    "rollerblades": "rollerblade",
    "rolls": "roll",
    "sandwich bags": "sandwich bag",
    "sausages": "sausage",
    "scales": "scale",
    "scallops": "scallop",
    ...
    "vacuum cleaner attachments": "vacuum cleaner attachment",
    "vegetable seeds": "vegetable seed",
...
def build_entries(raw_text: str) -> tuple[list[dict], dict]:
    ...
    for entry in parsed:
        ...
        singular_text = ORDINARY_PLURAL_ENTRY_TEXT.get(normalized_text.casefold())
        if singular_text:
            report.setdefault("correctedEntryText", []).append({"line": entry.line, "to": singular_text, "refs": entry.refs})
            normalized_text = singular_text
